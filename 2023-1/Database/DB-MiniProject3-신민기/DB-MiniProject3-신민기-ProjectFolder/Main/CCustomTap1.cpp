...
IMPLEMENT_DYNAMIC(CCustomTap1, CDialogEx)

CCustomTap1::CCustomTap1(CWnd* pParent /*=nullptr*/)
	: CDialogEx(CustomTap1, pParent)
{

}

CCustomTap1::~CCustomTap1()
{
}

void CCustomTap1::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCustomTap1, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON1, &CCustomTap1::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CCustomTap1::OnBnClickedButton1()
{
